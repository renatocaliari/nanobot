...
def gateway(
    ...
    # Create provider (supports OpenRouter, Anthropic, OpenAI, Z.AI, Gemini, vLLM)
    api_key = config.get_api_key()
    api_base = config.get_api_base()

    if not api_key:
        console.print("[red]Error: No API key configured.[/red]")
        console.print("Set one in ~/.nanobot/config.json or environment variables:")
        console.print("  - providers.zai.apiKey (Z.AI/Zhipu AI)")
        console.print("  - providers.openrouter.apiKey (OpenRouter)")
        console.print("  - providers.anthropic.apiKey (Anthropic)")
        console.print("  - providers.openai.apiKey (OpenAI)")
        console.print("  - providers.gemini.apiKey (Gemini)")
        console.print("  - providers.vllm.apiKey (vLLM)")
        raise typer.Exit(1)
